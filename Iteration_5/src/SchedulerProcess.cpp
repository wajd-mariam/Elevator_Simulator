            ...
            while(!done && !stopAll){
                ...
                for(size_t i=0; i<N; i++){
                    ...
                    if(cID == eID){
                        ...
                        // Sending information to the UI
                        ElevatorStatus statusUpdate = elevInfo[eID];
                        //std::string msg = serializeElevatorStatus(statusUpdate);
                        //udpSendString(sendSock, msg, "127.0.0.1", uiPort);
